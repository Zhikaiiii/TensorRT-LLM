...
class QWenMLP(Module):
    ...
    def __init__(self,
        ...
        if self.use_fp8_qdq:
            self.fc1 = FP8Linear(hidden_size,
                                ffn_hidden_size,
                                bias=bias,
                                dtype=dtype,
                                tp_group=tp_group,
                                tp_size=tp_size,
                                gather_output=False)
            self.fc2 = FP8Linear(hidden_size,
                                ffn_hidden_size,
                                bias=bias,
                                dtype=dtype,
                                tp_group=tp_group,
            ...
            self.fc1 = ColumnLinear(hidden_size,
                                   ffn_hidden_size,
                                   bias=bias,
                                   dtype=dtype,
                                   tp_group=tp_group,
                                   tp_size=tp_size,
                                   gather_output=False)
            self.fc2 = ColumnLinear(hidden_size,
                                   ffn_hidden_size,
                                   bias=bias,
                                   dtype=dtype,
                                   tp_group=tp_group,
    ...
    def forward(self, hidden_states, workspace=None):
        ...
        inter = inter * ACT2FN[self.hidden_act](self.fc2(hidden_states))
